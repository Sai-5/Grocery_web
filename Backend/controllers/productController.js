...
exports.createProduct = async (req, res) => {
    try {
        const { productname, price, description, category, image, countInStock,rating, dateCreated } = req.body;
        const newProduct = new models.Product({ productname, price, description, category, image, countInStock,rating, dateCreated });
