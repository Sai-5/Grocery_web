...
//   useEffect(() => {
//     axios
//       .get(`http://localhost:5100/api/admin/getAllUsers`)
//       .then((response) => setUsers(response.data))
//       .catch((error) => console.error("Failed to fetch users", error));
//   }, []);

//   const deleteUser = (userId) => {
//     axios.delete(`http://localhost:5100/api/admin/${userId}`);
//     window.location.assign("/admin/users");
//     alert("User is deleted");
//   };

//   const deleteOrder = (orderId) => {
//     axios.delete(`http://localhost:5100/api/orders/${orderId}`);
//     window.location.assign("/admin/users");
//     alert("Order deleted");
//   };
...
const backgroundStyle = {
  backgroundImage: "url('https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?fit=crop&w=1920&q=80')",
